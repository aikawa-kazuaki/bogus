const hohreiQuestions = [
    ...
    },
    {
        ...
        hasFacility: true,
        facilityId: "r7_q13_20",
        explanation: "一般則第6条第1項第17号等により、ポンプ、圧縮機、蒸発器、容器置場等は耐震設計構造物に該当しないため「全て」とするのは誤り。"
    },
    {
        id: 52,
...
// data/hohrei_r5.js
    // --- 問1 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第1条の規定により正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第2条第3号後段の規定により正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第2条第1号前段・後段の規定により、現在の圧力が1メガパスカル未満であり、温度35度においては1メガパスカル未満となるため高圧ガスに該当せず正しいです。"
    },
    ...
    // --- 問2 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第22条第1項の規定により、輸入した高圧ガス及びその容器の両方について輸入検査を受けなければならないため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第63条第1項第1号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第24条の2第1項及び令第7条の規定により正しいため○です。"
    },
    ...
    // --- 問3 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第5条第1項本文及び第1号、令第3条の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第3条第2項により一部の条項が適用除外されるのみであり、すべてではないため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第20条の4の規定により、事業開始の日の20日前までに届け出なければならないため誤りです。"
    },
    ...
    // --- 問4 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "一般則第103条の計算式に基づき算定すると基準値（1800m³）と同量となり、第一種貯蔵所での貯蔵が必要なため正しいです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "第一種ガスは3000立方メートル以上の場合に第一種貯蔵所が必要であり、600立方メートルでは達しないため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "第二種ガスは1000立方メートル以上の場合に第一種貯蔵所が必要であり、900立方メートルでは達しないため誤りです。"
    },
    ...
    // --- 問5 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第44条第1項の規定により正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第48条第4項第1号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第56条第5項により、容器の附属品についてもくず化等の処分が義務付けられているため誤りです。"
    },
    ...
    // --- 問6 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "容器保安規則第8条第1項の刻印事項に最大充填質量は規定されていないため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "当該式は低温容器に充填する場合のものであり、一般継目なし容器（低温容器除く）の場合は異なるため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "容器保安規則第24条第1項第3号により、一般継目なし容器の再検査期間は一律5年と定められており正しいです。"
    },
    ...
    // --- 問7 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "液石則第53条第1項第2号において、減圧設備を地盤面下に埋設した場合の距離緩和の規定はないため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第28条第2項及び液石則第71条第3号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第28条第2項・第3項により都道府県知事等への届出が必要であるため誤りです。"
    },
    ...
    // --- 問8（事業所データ連動：コンビ） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "コンビナート則第5条第1項第5号・第6号に保安物件までの距離が規定されているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "コンビナート則第5条第1項第9号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "コンビナート則第5条第1項第12号の規定により正しいため○です。"
    },
    ...
    // --- 問9（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "コンビナート則第5条第1項第25号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "1メートルまたは最大直径の和の4分の1のいずれか大なるものとされているため一律1メートルではなく誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "市街地や湖沼等を横断する導管も対象であるため「主要河川を横断するものに限り」は誤りです。"
    },
    ...
    // --- 問10（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第27条の3第2項により、保安統括者の要件にかかわらず保安企画推進員の選任が必要であるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "免状の種類が甲種化学・機械に限定されているわけではないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第27条の2第5・6項、法第33条第3項の規定により正しいため○です。"
    },
    ...
    // --- 問11（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第27条の3第3項により保安企画推進員にも講習を受けさせる必要があるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第32条第3項及びコンビナート則第31条第5号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第35条の2により検査記録の作成・保存は義務付けられていますが行政への届出規定はないため誤りです。"
    },
    ...
    // --- 問12（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第27条第1項・第3項により計画の実行は義務ですが、都道府県知事等への届出規定はないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "コンビナート則第22条第2項第10号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q8_12",
        explanation: "法第26条第3項により、守るべき者は事業者及びその従業者とされており、協力会社の従業者は含まれないため誤りです。"
    },
    ...
    // --- 問13（事業所データ連動：一般則） ---
    {
        ...
        explanation: "法第20条第3項の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "法第14条第1項及び一般則第15条第1項第4号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "法第20条第3項及び一般則第33条第1号の規定により正しいため○です。"
    },
    ...
    // --- 問14（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第4号により、高圧ガス設備間の距離は障壁による距離緩和が認められていないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第15号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "安全装置は「許容圧力を超えた場合」に直ちに戻すものでなければならないため「1.5倍を超えた場合」は誤りです。"
    },
    ...
    // --- 問15（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第3号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第39号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第31号により酸素の製造施設には設置義務がないため正しいです。"
    },
    ...
    // --- 問16（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "毒性ガスかつ5トン以上の液化アンモニア貯槽に該当するため正しく、他の貯槽は対象外であるため正しいです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第11号により常用の圧力の1.5倍以上とされているため1.25倍は誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第27号の規定により正しいため○です。"
    },
    ...
    // --- 問17（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第22号により、液面計は液化ガスの貯槽すべてについて規定されているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第9号により、この措置は可燃性ガス及び特定不活性ガスについてのみ規定されているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第32号の規定により正しいため○です。"
    },
    ...
    // --- 問18（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第35号によりねじ接合継手による接合も認められているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "製造設備全体が対象でありガス設備に限定されていないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第1項第42号ハの規定により正しいため○です。"
    },
    ...
    // --- 問19（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "安全弁や逃し弁の止め弁は、原則として常に全開しておかなければならないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第2項第4号により、ガスの種類による点検方法の簡素化は認められていないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第2項第5号二の規定によりガスの種類にかかわらず措置が必要であり正しいです。"
    },
    ...
    // --- 問20（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第2項第8号チの規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第2項第8号イの規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r5_q13_20",
        explanation: "一般則第6条第2項第8号ホの規定により残ガス容器も含めて正しいため○です。"
    },
...
// data/hohrei_r4.js
    // --- 問1 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "帳簿の保存期間は記載の日から10年間とされており、製造開始の日からではないため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第20条の4ただし書及び同条第1号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "特定高圧ガス消費者は、消費開始の日の20日前までに届け出ることとされているため誤りです。"
    },
    ...
    // --- 問2 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第22条第1項ただし書及び同項第1号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "第一種製造者が製造の許可を受けたところに従って高圧ガスを貯蔵するときは、重ねて貯蔵の許可を受ける必要はないため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "第一種製造者は製造をする高圧ガスの種類を変更しようとするときは、都道府県知事等の許可を受けることとされているため誤りです。"
    },
    ...
    // --- 問3 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "ガスの種類によっては令第3条の規定により1日300立方メートル以上であるため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第37条第1項の規定により正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第10条第1項の規定により正しいため○です。"
    },
    ...
    // --- 問4 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "民間事業者及び高圧ガス保安協会による保安に関する自主的な活動の促進なども定めているため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第2条第3号前段等の規定により高圧ガスとならず正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第2条第2号前段・後段のいずれに照らしても高圧ガスにならないため誤りです。"
    },
    ...
    // --- 問5 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第45条第1項及び容器規則第8条第1項の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "容器再検査を受けて合格し、かつその旨の刻印等がされているものでなければ充填できないため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第56条第5項の規定に反するため誤りです。"
    },
    ...
    // --- 問6 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "容器規則第8条第1項第3号に刻印事項として規定されているため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "容器規則第22条に示されている計算式は G = V / C であるため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "容器規則第24条第1項の規定により経過年数に関係して定められており正しいため○です。"
    },
    ...
    // --- 問7 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "液石則第71条第1号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "液石則第53条第2項第1号の規定により置くことができないため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "減圧設備についても保安物件に対して所定の距離を有することとされているため誤りです。"
    },
    ...
    // --- 問8（事業所データ連動：コンビナート） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "法第39条の11第2項の規定により、届出をした場合には都道府県知事等が行う保安検査を受けなくてもよいため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第38条第4項の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "当該職務は保安企画推進員の職務であり、保安主任者の職務ではないため誤りです。"
    },
    ...
    // --- 問9（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第29条第4号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "乙種化学責任者免状又は乙種機械責任者免状の交付を受けている者も選任することができるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "免状の交付を受け、かつ経験を有する者でなければならず「いずれか一方」ではないため誤りです。"
    },
    ...
    // --- 問10（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第5条第1項第27号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "主要河川、湖沼等を横断する導管についても設けることとされているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第11条第3項第7号の規定により正しいため○です。"
    },
    ...
    // --- 問11（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "事業所内の全ての製造設備が危険な状態になった場合に必要な数量とされているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第5条第1項第5号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第5条第1項第9号の規定により正しいため○です。"
    },
    ...
    // --- 問12（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "新たな製造施設の追加の工事は自ら検査を行うことのできる特定変更工事の対象外であるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第17条により完成検査を要しない変更の工事があるため正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第14条第1項第2号により軽微な変更の工事に該当し正しいため○です。"
    },
    ...
    // --- 問13（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "法第26条第1項及び第3項の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "更新時ではなく「遅滞なく」経済産業大臣に届け出なければならないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q8_13",
        explanation: "コンビ則第49条第2項の規定により正しいため○です。"
    },
    ...
    // --- 問14（事業所データ連動：一般則） ---
    {
        ...
        explanation: "一般則第6条第1項第19号の規定により正しいため○です。"
    },
    {
    ...
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "酸素の製造設備についてもこの措置を講ずる必要はないため「窒素以外」とする記述は誤りです。"
    },
    ...
    // --- 問15（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第1項第17号の規定により該当しないため正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "高圧ガス設備以外のガス設備もこの規定が適用されるため「限られている」は誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第1項第4号により設備間距離についての障壁による緩和規定がないため誤りです。"
    },
    ...
    // --- 問16（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "水その他の安全な液体を使用して行うこととされており、アセチレンに関して気体による耐圧試験が義務付けられているわけではないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第1項第16号の規定により貯蔵能力1トン以上の貯槽について沈下状況を測定することとされており正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第1項第22号の規定により正しいため○です。"
    },
    ...
    // --- 問17（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第1項第25号の規定により正しいため○です。"
    },
    {
    ...
    // --- 問18（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第1項第33号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "毒性ガスのガス設備の配管接合は、フランジ接合又はねじ接合継手による接合も認められるため誤りです。"
    },
    {
    ...
    // --- 問19（事業所データ連動） ---
    {
        ...
        question: "高圧ガスの安全弁に付帯して設けた止め弁は、製造設備の使用終了年から使用開始時までの間は、不用意なガスの放出を防ぐため、閉止しておかなければならない。",
        isTrue: false,
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "修理又は清掃のため特に必要な場合を除き、常に全開しておかなければならないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "ガスの種類等による簡素化や免除の規定はないが、問題文の前半や後半の解釈において一般則第6条第2項第4号に基づく正確な規定と照らし合わされ検証される（解説では誤りとされる部分を含む）。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "修理等の「等」には清掃も含まれるため、確認が必要であり誤りです。"
    },
    ...
    // --- 問20（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "一般則第6条第2項第8号二の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "圧縮窒素の容器についても充填容器及び残ガス容器に区分して置くこととされているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r4_q14_20",
        explanation: "液化アンモニアの充填容器と圧縮窒素の充填容器についても区分すべき定めがあるため誤りです。"
    },
  ...
  // data/hohrei_r3.js
    // --- 問1 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第1条の目的に合致しているため正しく○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "法第2条第3号後段の規定により高圧ガスに該当するため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第2条第1号の規定により高圧ガスとならず正しいため○です。"
    },
    ...
    // --- 問2 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "事業の譲渡における第一種製造者の地位承継の規定はないため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "第一種ガス等の処理容積要件を満たしており正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "第二種貯蔵所の基準は第一種貯蔵所の基準を準用しており正しいため○です。"
    },
    ...
    // --- 問3 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第14条第1項の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "販売事業の届出は事業開始の日の20日前までに行う必要があるため誤りです。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "水素、アセチレン及び塩化ビニル以外のガスについて法が適用されないため、「ガスの種類にかかわらず」は誤りです。"
    },
    ...
    // --- 問4 ---
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第60条第1項等の規定により正しいため○です。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第25条及び一般則第61条の規定により正しいため○です。"
    },
    {
    ...
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "法第44条第1項第4号の規定により正しいため○です。"
    },
    {
    ...
    // --- 問6 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "容器の内容積の刻印は圧縮ガス容器・液化ガス容器双方に適用されるため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "容器規則第18条第1項第6号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "水素容器の塗色は赤色、文字は「燃」であるため誤りです。"
    },
    ...
    // --- 問7 ---
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "地盤の如何にかかわらず貯槽の支柱を同一の基礎に緊結しなければならないため誤りです。"
    },
    {
        ...
        isTrue: true,
        hasFacility: false,
        explanation: "液石則第53条第2項第1号の規定により正しいため○です。"
    },
    {
        ...
        isTrue: false,
        hasFacility: false,
        explanation: "障壁による減圧設備の距離緩和規定はないため誤りです。"
    },
    ...
    // --- 問8（事業所データ連動：コンビナート） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "保安統括者の免状や経験によっては保安技術管理者の選任が不要な場合もあるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "コンビ則第28条第3項の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "法第33条第1項の規定により正しいため○です。"
    },
    ...
    // --- 問9（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "コンビ則第32条第6号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "法第35条第1項ただし書および第39条の11第2項の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "保安教育計画の実行結果を都道府県知事等へ届け出る義務はないため誤りです。"
    },
    ...
    // --- 問10（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "コンビ則第5条第1項第7号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "コンビ則第5条第1項第10号イの規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "設備の作動に必要な数量の水を常時保有することが義務付けられているため誤りです。"
    },
    ...
    // --- 問11（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "コンビ則第5条第1項第25号および第27号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "計器室の設置位置には制限があるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "屋外消火栓を設置したときも書面の送付が必要であるため誤りです。"
    },
    ...
    // --- 問12（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "特定変更工事に該当せず完成検査を要しないため正しく○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "完成検査の記録を都道府県知事等に届け出なければ施設を使用できないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "軽微な変更の工事に該当し、完成後の届出でよいため正しく○です。"
    },
    ...
    // --- 問13（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "新たな製造施設の追加工事は「特定変更工事」の自ら行う完成検査の対象外であるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "継続して2年以上高圧ガスを製造しているものに限定されているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q8_13",
        explanation: "法第39条の9第2項の規定により正しいため○です。"
    },
    ...
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "不活性ガス・空気以外の高圧ガス設備等に設ける安全弁には放出管が必要であり、液化酸素の貯槽にも放出管を設けなければならないため誤りです。"
    },
    ...
    // --- 問15（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "可燃性ガスと酸素の製造設備の間は10メートル以上の距離が必要であるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "一般則第6条第1項第29号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "酸素の製造施設にも防消火設備の設置が必要であるため誤りです。"
    },
    ...
    // --- 問16（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "水その他の安全な液体を使用する場合は常用の圧力の1.5倍以上の圧力で行うため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "液化アンモニアの貯槽に丸形ガラス管液面計を使用してはならないとされているため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "一般則第6条第1項第8号の規定により正しいため○です。"
    },
    ...
    // --- 問17（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "一般則第6条第1項第26号の規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "貯槽の支柱にも温度上昇防止措置が必要であるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "不活性ガスの貯槽（貯蔵能力1t以上）は耐震性能の有無にかかわらず沈下状況の測定が必要なため誤りです。"
    },
    ...
    // --- 問18（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "危険標識の掲示に加え、外部から毒性ガスの製造施設である旨を容易に識別できる措置が必要であるため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "一般則第6条第1項第37号および第42号チの規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "容器置場の距離は処理・貯蔵能力ではなく容器置場の「面積」に応じて定められているため誤りです。"
    },
    ...
    // --- 問19（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "修理等特別に必要な場合を除き常に全開しておかなければならないため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "一般則第6条第2項第2号イの規定により正しいため○です。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "使用開始時・終了時の点検に加え、1日に1回以上頻繁に作動状況の点検を行う必要があるため誤りです。"
    },
    ...
    // --- 問20（事業所データ連動） ---
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "ガスの性質・種類にかかわらず酸素や窒素の製造設備も含めすべての設備に必要なため誤りです。"
    },
    {
        ...
        hasFacility: true,
        facilityId: "r3_q14_20",
        explanation: "圧縮窒素の容器についても充填容器と残ガス容器に区分して置く必要があるため誤りです。"
    },
    {
